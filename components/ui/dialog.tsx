...
export function DialogBackdrop({
  ...
  return (
    <DialogPrimitive.Backdrop
        className={cn(
          "fixed inset-0 z-50 bg-black/15 backdrop-blur-[2px] transition-all duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
          className,
        )}
...
export function DialogHeader({
  ...
  const defaultProps = {
    className: cn(
        "flex flex-col gap-2 px-5 py-8 in-[[data-slot=dialog-popup]:has([data-slot=dialog-panel])]:pb-3 max-sm:pb-4",
      className,
    ),
...
export function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn(
        "font-normal text-xl leading-none",
        className,
      )}
