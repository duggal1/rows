  ...
  return (
    <MenuPortal {...portalProps}>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "relative flex not-[class*='w-']:min-w-32 origin-(--transform-origin) rounded-lg border bg-zinc-50 border-zinc-100 outline-none focus:outline-none dark:bg-zinc-900 dark:border-zinc-800",
            className,
          )}
